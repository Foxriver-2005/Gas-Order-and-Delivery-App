...
import com.lelei.b_r_gas.Helper.GMailSender;
...
import com.lelei.b_r_gas.Remote.RetroFitClient;
...
public class Common {
    ...
    public static String Name = "flo gas Staff";

    public static String feedback_remember = "1";

    public static String topicName = "News";

    private static String sender_mail = "foxriver@gmail.com";
    private static String password = "Leleih24";
    ...
    public static List<ItemOrder> list = new ArrayList<>();
