...
import com.lelei.b_r_gas.admin.ViewHolder.ViewSoldItemsHolder;
import com.lelei.b_r_gas.admin.ViewHolder.ViewSoldItemsHolderRequest;
...
public class ViewSoldItems extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent()!=null){
            ...
            itemsSold = database.getReference("SoldItems").child(month).child(date).child("Products");
        }
