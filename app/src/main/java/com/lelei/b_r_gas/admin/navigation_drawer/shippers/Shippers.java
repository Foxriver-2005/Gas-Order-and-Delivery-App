package com.lelei.b_r_gas.admin.navigation_drawer.shippers;
...
import com.lelei.b_r_gas.admin.ViewHolder.ShipperViewHolder;
...
public class Shippers extends Fragment {
    ...
    com.lelei.b_r_gas.Model.Shippers newshippers;

    private FirebaseRecyclerAdapter<com.lelei.b_r_gas.Model.Shippers, ShipperViewHolder> adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adapter = new FirebaseRecyclerAdapter<com.lelei.b_r_gas.Model.Shippers, ShipperViewHolder>(
                com.lelei.b_r_gas.Model.Shippers.class,
                R.layout.shipper_profiles,
                ShipperViewHolder.class, shippers
        ) {
            @Override
            protected void populateViewHolder(ShipperViewHolder shipperViewHolder, com.lelei.b_r_gas.Model.Shippers shippers, int i) {
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getTitle().equals(Common.UPDATE)){
            ...
            com.lelei.b_r_gas.Model.Shippers s = adapter.getItem(item.getOrder());
    ...
    private void showUpdateDialog(final String key, com.lelei.b_r_gas.Model.Shippers item){
        ...
        dialogf.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validateName(shipperUser) && validatePass(shipperPass)
                    ...
                    newshippers = new com.lelei.b_r_gas.Model.Shippers(name,
                            pass,
                            phone,
                            email);
