package com.lelei.b_r_gas.user.navigation_drawer.home_user;
...
import com.lelei.b_r_gas.user.navigation_drawer.cart_user.Cart;
...
public class Home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        items = database.getReference("Products");
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    adapter = new FirebaseRecyclerAdapter<Item, MenuViewHolder>
                            (Item.class, R.layout.menu_item, MenuViewHolder.class, items) {
                        @Override
                        protected void populateViewHolder(final MenuViewHolder menuViewHolder, final Item model, final int i) {
            ...
            flags.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (Common.flags != null) {
                        ...
                        // Handle case where flags are null
                        // You might want to hide or show a default message
                    }
                }
