package com.lelei.b_r_gas.user.navigation_drawer.settings_user;
...
import com.lelei.b_r_gas.common.Credits;
import com.lelei.b_r_gas.common.UpdateActivity;
import com.lelei.b_r_gas.login.Login;
import com.lelei.b_r_gas.user.FeedbackActivity;
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat{
        ...
        private void contactUs() {
            ...
            contact_telegram.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent sendtelegram = new Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/fox_river2005"));
            ...
            contact_email.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mUser != null){
                        ...
                        sendEmail.setData(Uri.parse("mailto:foxriver2471@gmail.com"));
